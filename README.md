...
Harkins & Kumari        Expires December 5, 2016                [Page 1]

...
1.  Introduction
   ...
   This memo describes a mode of opportunistic encryption for 802.11--
   OWE-- that provides encryption of the wireless medium but no
   authentication.
...
Harkins & Kumari        Expires December 5, 2016                [Page 2]

Internet-Draft              Abbreviated Title                  June 2016
...
2.  Background
   ...
   factor in which business to enter.  Since these businesses are not
   service providers they are not willing and/or not qualified to
   perform complex configuration on their network.  Also, customers too
   are not willing to do complicated provisioning on their devices just
   to obtain free Wi-Fi.  This leads to a popular deployment technique--
   a network protected using a shared, and public PSK that is printed on
   a sandwich board at the enterance, on a chalkboard on the wall, or on
   a menu.  The PSK is used in a cryptographic handshake defined in
   ...
   open and unencrypted network.  Instead of using a shared and public
   PSK in the 4-way Handshake, the client and AP can perform a Diffie-
   Hellman key exchange during the access procedure and use the
   resulting pairwise secret with the 4-way Handshake.  This is the
   essense of OWE.
   ...
   PSK-- more security and easier to use.
...
Harkins & Kumari        Expires December 5, 2016                [Page 3]

Internet-Draft              Abbreviated Title                  June 2016
...
Harkins & Kumari        Expires December 5, 2016                [Page 4]

Internet-Draft              Abbreviated Title                  June 2016
...
Harkins & Kumari        Expires December 5, 2016                [Page 5]

Internet-Draft              Abbreviated Title                  June 2016
   ...
   A client that wishing to do OWE MUST indicate the OWE AKM in the RSN
...
Harkins & Kumari        Expires December 5, 2016                [Page 6]

Internet-Draft              Abbreviated Title                  June 2016
...
Harkins & Kumari        Expires December 5, 2016                [Page 7]

Internet-Draft              Abbreviated Title                  June 2016
...
6.  Implementation Considerations
   ...
   "Open", it just provides more security under the covers.
...
Harkins & Kumari        Expires December 5, 2016                [Page 8]

Internet-Draft              Abbreviated Title                  June 2016
...
Harkins & Kumari        Expires December 5, 2016                [Page 9]
```
